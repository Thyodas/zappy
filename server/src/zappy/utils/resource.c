...
/**
 * Resolves a resource name to its corresponding resource type in the Zappy game.
 *
 * @param zappy - The Zappy data structure.
 * @param resource_name - The name of the resource.
 * @param result - Pointer to the variable to store the resulting resource type.
 * @return 0 on success, 1 if the resource name is not found in the resource map.
 */
